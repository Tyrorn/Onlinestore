namespace _17327291_Onlinestore.Migrations.StoreConfiguration
{
    ...
    internal sealed class StoreConfiguration : DbMigrationsConfiguration<_17327291_Onlinestore.OSDB.StoreContext>
    {
        ...
        protected override void Seed(_17327291_Onlinestore.OSDB.StoreContext context)
        {
            ...
            var products = new List<Product>
            {
                ...
                new Product {Name = "8Ware USB Blutooth", Description = "V4 0 Adapter Version", Price = 19.49M, CategoryID= categories.Single(c=>c.Name == "Networking").ID},
                ...
                new Product {Name = "Microsoft Home 10", Description = "64 bit Home office", Price = 171, CategoryID= categories.Single(c=>c.Name == "Software and Games").ID},
                new Product {Name = "Microsoft XBox One X", Description = "1 TB Xbox One", Price = 749, CategoryID= categories.Single(c=>c.Name == "TV Video and Audio").ID},
                new Product {Name = "TP Link NC 450", Description = "HD Tilt Wifi Camera", Price = 163.31M, CategoryID= categories.Single(c=>c.Name == "Cameras and Drones").ID},
