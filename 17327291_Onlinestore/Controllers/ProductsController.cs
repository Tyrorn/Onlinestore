...
using _17327291_Onlinestore.OSDB;
...
//find the products where either the product name field contains search, the product description contains search, 
//or the product's category name contains search.
